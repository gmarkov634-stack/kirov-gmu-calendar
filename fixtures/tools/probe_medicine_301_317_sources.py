#!/usr/bin/env python3
"""Mechanical XLSX source probe for KGMU medicine groups 301-317.
...
targets for operator/ChatGPT review under canonical G/R/C/S rules.
"""
import hashlib
import html
import io
...
OUT = ROOT / "medicine-301-317-source-probe.json"
TIMETABLE_PAGE = "https://kirovgma.ru/lechebnyy-fakultet-raspisanie"
ALLOWED_PREFIX = "/sites/default/files/files/"
STREAM_PATTERNS = {
    "301-310": re.compile(r"3_lech\._1_potok[^\"'<>\s]*\.xlsx", re.IGNORECASE),
    "311-317": re.compile(r"3_lech_2_potok[^\"'<>\s]*\.xlsx", re.IGNORECASE),
}
