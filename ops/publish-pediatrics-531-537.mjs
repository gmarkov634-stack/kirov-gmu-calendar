...
try {
  ...
  console.log(JSON.stringify({ result: 'PRODUCTION_PEDIATRICS_COURSE_5_SCHEDULES_PUBLISHED_AND_VERIFIED', coreBoundary: boundary, groupCount: plan.versions.length, eventCount: plan.events.length, oldScheduleVersionRowsPreserved: true }, null, 2));
} finally {
  database.close();
}
