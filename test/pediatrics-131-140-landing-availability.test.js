...
test("pediatrics course 1 remains exposed when courses 2 through 5 are published", async () => {
  ...
  assert.match(source, /Группы 131–140, 231–239, 331–337, 431–436 и 531–537 · опубликованы и доступны/);
