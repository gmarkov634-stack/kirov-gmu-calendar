...
test("pediatrics course 1 remains exposed when courses 2 through 6 are published", async () => {
  ...
  assert.match(source, /Группы 131–140, 231–239, 331–337, 431–436, 531–537 и 631–637 · опубликованы и доступны/);
