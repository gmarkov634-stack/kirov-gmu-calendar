(() => {
  ...
  // Демо построено по структуре расписания 1 курса лечебного факультета КГМУ.
  // Названия корпусов и аудиторий используются в формулировках реального расписания КГМУ.
  const days = [
    {
      weekday: 'Понедельник', date: '16 марта',
      events: [
