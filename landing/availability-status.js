  ...
  function refresh() {
    for (const card of document.querySelectorAll(".program-card")) {
      ...
      if (program === "Стоматология") {
        ...
        setText(card.querySelector("p"), "Группы 191–194 · опубликованы и доступны для 7-дневной бесплатной пробы");
      }
    }

    const availability = document.querySelector(".availability");
    setText(availability?.querySelector("strong"), "Лечебное дело: 1–6 курсы опубликованы · Педиатрия: 1–6 курсы опубликованы · Стоматология: 1 курс опубликован");
    setText(availability?.querySelector("p"), "Лечебное дело: группы 101–120, 201–220, 301–317, 401–416, 501–516 и 601–616; педиатрия: группы 131–140, 231–239, 331–337, 431–436, 531–537 и 631–637; стоматология: группы 191–194. Расписания опубликованы по проверенным официальным расписаниям КГМУ и доступны для подключения через 7-дневную бесплатную пробу.");

    setText(document.querySelector("#hero-runtime-note"), "Лечебное дело: группы 101–120, 201–220, 301–317, 401–416, 501–516 и 601–616; педиатрия: группы 131–140, 231–239, 331–337, 431–436, 531–537 и 631–637; стоматология: группы 191–194 опубликованы и доступны. Выберите группу и запустите бесплатную пробу на 7 дней.");
