  ...
  function refresh() {
    for (const card of document.querySelectorAll(".program-card")) {
      ...
      if (program === "Педиатрия") {
        setText(card.querySelector(".program-badge"), "1–2 курсы доступны");
        setText(card.querySelector("p"), "Группы 131–140 и 231–239 · опубликованы и доступны для 7-дневной бесплатной пробы");
      }
    }

    const availability = document.querySelector(".availability");
    setText(availability?.querySelector("strong"), "Лечебное дело: 1–6 курсы опубликованы · Педиатрия: 1–2 курсы опубликованы");
    setText(availability?.querySelector("p"), "Лечебное дело: группы 101–120, 201–220, 301–317, 401–416, 501–516 и 601–616; педиатрия: группы 131–140 и 231–239. Расписания опубликованы по проверенным официальным расписаниям КГМУ и доступны для подключения через 7-дневную бесплатную пробу.");

    setText(document.querySelector("#hero-runtime-note"), "Лечебное дело: группы 101–120, 201–220, 301–317, 401–416, 501–516 и 601–616; педиатрия: группы 131–140 и 231–239 опубликованы и доступны. Выберите группу и запустите бесплатную пробу на 7 дней.");
